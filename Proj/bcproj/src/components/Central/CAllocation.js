...
class CAllocation extends Component {
                ...
                <div className="col s12 m12">
                  <div className="card blue-grey darken-1">
                    <div className="card-content white-text">
                      ...
                      <div>Project Leader:{Project_Leader}</div>
                      <div>Budget: Rs.{Budget}</div>
                    </div>
                    <div class="card-action">
                      <a href='https://www.google.com/'>Details</a>
                      {/* <Button  variant='contained' name={id} size='large' onClick={()=>this.handleAccept(id)} >Accept</Button>
                      <Button variant='contained' value={id} size='large' onClick={this.handleReject}>Reject</Button> */}
                    </div>
                  </div>
                </div>
              </div>
